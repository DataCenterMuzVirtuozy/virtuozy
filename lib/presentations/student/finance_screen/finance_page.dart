...
class _FinancePageState extends State<FinancePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:
          widget.selIndexDirection < 0 ? null : const AppBarCustom(title: ''),
      body: BlocConsumer<BlocFinance, StateFinance>(listener: (c, s) {
        ...
        if (state.user.userStatus.isModeration ||
            state.user.userStatus.isNotAuth &&
                state.status == FinanceStatus.loaded) {
          return Center(
            child: BoxInfo(
                buttonVisible: state.user.userStatus.isNotAuth,
                title: state.user.userStatus.isModeration
                    ? 'Ваш аккаунт на модерации'.tr()
                    : 'Финансы недоступны'.tr(),
                description: state.user.userStatus.isModeration
                    ? 'На период модерации работа с финансами недоступна'.tr()
                    : 'Для работы с балансом счета необходимо авторизироваться'
                        .tr(),
          ...
          child: RefreshIndicator(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  DrawingMenuSelected(
                    initTitle: _titlesDirections.isNotEmpty
                        ? _titlesDirections[_selIndexDirection]
                        : '',
                    ...
                    onSelected: (index) {
                      ...
                      context.read<BlocFinance>().add(
                          GetBalanceSubscriptionEvent(
                              indexDirection: _selIndexDirection,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                                ParserPrice.getBalance(_summaBalance(
                            ...
                            Padding(
                              ...
                              child: Icon(CupertinoIcons.money_rubl,
                                  color: Theme.of(context)
                                      .textTheme
                                      .displayMedium!
                                      .color!,
                  ...
                  const Gap(10.0),
                  Visibility(
                    visible: ParserPrice.getBalance(
                            _summaBalance(directions: state.directions)) !=
                        '0.00',
                    child: BoxSubs(
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Expanded(
                              child: Text('История абонементов'.tr(),
                ...
                Column(
                  ...
                  children: [
                    ...
                    if (widget.subscription.status == StatusSub.active ||
                      ...
                      Visibility(
                        visible:
                            widget.subscription.status == StatusSub.inactive,
                        child: Container(
                ...
                Visibility(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      TeacherContacts(
                          contacts: widget.subscription.contactValues, size: 20)
                    ],
                  ),
                ),
                Visibility(
      ...
      children: [
        Visibility(
          ...
          child: Container(
            ...
            padding: const EdgeInsets.only(right: 8.0, left: 8.0, bottom: 2.0),
            decoration: BoxDecoration(
                color: colorGreen, borderRadius: BorderRadius.circular(10.0)),
            child: Text('активный',
                style: TStyle.textStyleVelaSansBold(colorWhite, size: 10.0)),
          ),
        ),
