...
class ListSubscriptionHistory extends StatefulWidget{
  const ListSubscriptionHistory({super.key, required this.directions});
...
class _ListSubscriptionHistoryState extends State<ListSubscriptionHistory> {
  ...
  void didChangeDependencies() {
   super.didChangeDependencies();
    directions = context.watch<BlocFinance>().state.directions;
                    ...
                    ...{
                      Expanded(
                        child: GroupedListView<SubscriptionEntity, String>(
                          ...
                          sort: false,
                          groupBy: (element) =>
                              DateTimeParser.getDateForCompare(date: element
                                  .dateBay),
