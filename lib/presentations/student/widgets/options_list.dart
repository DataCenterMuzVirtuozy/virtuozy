        ...
        children: [
          ...
          ...List.generate(subscription.options.length, (index) {
            ...
            return Row(
              children: [
                Icon(
                    subscription.options[index].status == OptionStatus.freezing
                        ? Icons.icecream
                        : Icons.free_breakfast_outlined,
                    color: colorGreen,
                    size: 10),
                ...
                Text(
                    subscription.options[index].status == OptionStatus.freezing
                        ...
                        : subscription.options[index].status ==
                                OptionStatus.holiday
                            ? 'Каникулы, активировано '.tr()
                            : subscription.options[index].status ==
                                    OptionStatus.prolongation
                                ? 'Продление, активировано '.tr()
