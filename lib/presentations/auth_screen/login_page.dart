...
class _LogInPageState extends State<LogInPage> {
  ...
  void didChangeDependencies() {
    ...
    _errorInitApp = appState.authStatusCheck == AuthStatusCheck.error;
  ...
  Widget _illustration(){
    ...
    if(!msk){
      ...
      return  Image.asset(illustration_5,height: 200,fit: BoxFit.cover,);
    }
                ...
                Column(
                  ...
                  children: [
                    ...
                    Visibility(
                      ...
                      state.authStatus == AuthStatus.errorLogIn||_errorInitApp,
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                          Text(
            state.authStatus == AuthStatus.sendRequestCode?'Не пришел пароль по СМС? Позвоните по телефону'
                                .tr():'В случае проблем с авторизацией? Позвоните по телефону'.tr(),
                    ...
                    InkWell(
                      onTap: () async {
                        if(!PreferencesUtil.urlSchool.isNotEmpty){
                          Dialoger.showActionMaterialSnackBar(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Icon(Icons.lock_reset,color: colorGrey,size: 14,),
                           const Gap(5.0),
                           Text('Забыл пароль',
