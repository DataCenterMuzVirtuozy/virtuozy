...
enum UserStatus { notAuth, auth, moderation, deleted }

enum UserType { teacher, student, unknown }
...
enum TypeBonus { money, subscription, lesson, unknown }
