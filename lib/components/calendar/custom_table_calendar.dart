...
class CustomTableCalendar<T> extends StatefulWidget {
  ...
  @override
  CustomTableCalendarState<T> createState() => CustomTableCalendarState<T>();
}

class CustomTableCalendarState<T> extends State<CustomTableCalendar<T>> {
