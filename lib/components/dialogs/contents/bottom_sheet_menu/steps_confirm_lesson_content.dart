...
class _StepsConfirmLessonState extends State<StepsConfirmLesson>
          ...
          Expanded(
            child: PageView(
              ...
              children: [
                if (widget.listNotAcceptLesson.length > 1) ...{
                  step_0(
                      lessonsNotAccept: widget.listNotAcceptLesson,
                      next: (l) {
                ...
                step_1(
                    next: () {
                      _pageController.animateToPage(
                          widget.listNotAcceptLesson.length == 1 ? 1 : 2,
                          duration: const Duration(milliseconds: 700),
                          curve: Curves.ease);
                      setState(() {
                        _stepIndex =
                ...
                step_2(
                    ...
                    negative: (value) {
                      setState(() {
                        if (value) {
                          context.read<SubBloc>().add(NotAcceptLessonEvent(
                              direction:
                                  _getDirectionByLesson(lessonEntity: _lesson),
                              lesson: _lesson));
                          _rating = -1;
                          _stepIndex =
                              widget.listNotAcceptLesson.length == 1 ? 3 : 4;
                          _pageController.jumpToPage(_stepIndex);
                        } else {
                          _stepIndex =
                              widget.listNotAcceptLesson.length == 1 ? 2 : 3;
  ...
  Widget step_0({
    required List<Lesson> lessonsNotAccept,
  ...
  Widget step_1(
          ...
          required DirectionLesson direction}) =>
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          TeacherContacts(
                              contacts: lesson.contactValues, size: 25)
                        ],
                      ),
                      const Gap(5),
                      Row(
  ...
  Widget step_2({required Function negative, required UserEntity user}) =>
      SingleChildScrollView(
        child: BlocConsumer<SubBloc, SubState>(listener: (c, s) {
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          SubmitButton(
                            ...
                            onTap: () {
                              if (_lesson.bonus) {
                                context.read<SubBloc>().add(AcceptLessonEvent(
                              ...
                              if (_getBalanceDirection(
                                      directions: user.directions,
                                      nameDirection:
                                          widget.lesson.nameDirection) ==
                                  0.0) {
                                Dialoger.showMessage(
                                    'Недостаточно средств на балансе'.tr());
                              } else {
                                context.read<SubBloc>().add(AcceptLessonEvent(
                                    direction: _getDirectionByLesson(
                                        lessonEntity: _lesson),
  ...
  double _getBalanceDirection(
      {required List<DirectionLesson> directions,
      required String nameDirection}) {
    final dir =
        directions.firstWhere((element) => element.name == nameDirection);
          ...
          children: [
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                      _rating < 2.0 && _rating > 0.0
                          ? 'Сожалеем, что урок вам \nне понравился'.tr()
                          : 'Расскажите о причине, по которой урок не состоялся'
                              .tr(),
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        if (_getBalanceDirection(
                directions: user.directions,
                nameDirection: widget.lesson.nameDirection) ==
            0.0) {
            ...
            Row(
              ...
              children: [
                Container(
                  ...
                  height: 8.0,
                  decoration:
                      BoxDecoration(shape: BoxShape.circle, color: colorGreen),
                ),
                const Gap(10.0),
                Column(
                  mainAxisAlignment: MainAxisAlignment.center,
            ...
            IconButton(
              onPressed: () {
                if (_getBalanceDirection(
                  ...
                  currentDayNotifi.value =
                      _getIntCurrentDay(widget.lesson.date);
                  widget.next.call(widget.lesson);
                }
              },
