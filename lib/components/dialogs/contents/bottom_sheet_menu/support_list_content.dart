...
class _SupportListContentState extends State<SupportListContent> with AuthMixin{
  ...
  Widget build(BuildContext context) {
   return  Padding(
      ...
      child: Column(
        children: [
          ...List.generate(_getLength(widget.typeMessager,user.branchName), (index){
            return InkWell(
              onTap: () async {
                await _launchUrl(_getUrl(widget.typeMessager, index, user.branchName));
              },
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                     Image.asset(_pathsIcon[widget.typeMessager == TypeMessager.telegram?0:1],
                       width: 40,height: 40,),
                     const Gap(10),
                     Expanded(
                       child: Text(_getTitle(widget.typeMessager, index, user.branchName),
