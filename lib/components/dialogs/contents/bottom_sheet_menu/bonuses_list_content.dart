...
class _BonusesListContentState extends State<BonusesListContent> with AuthMixin {
  @override
...
class ItemBonus extends StatelessWidget{
  ...
  DirectionLesson _getDirectionByBonus({required BonusEntity bonus,required List<DirectionLesson> directions}){
   return directions.firstWhere((element) => element.name == bonus.nameDirection);
     ...
     child: Column(
      ...
      children: [
       Padding(
        ...
        child: Text(bonus.title,style: TStyle.textStyleVelaSansExtraBolt(Theme.of(context).textTheme.displayMedium!.color!,size: 18.0)),
       ),
       const Gap(5.0),
       Row(
        children: [
         ...
         const Gap(15.0),
         Expanded(child: Text(bonus.description,
             maxLines: 2,
